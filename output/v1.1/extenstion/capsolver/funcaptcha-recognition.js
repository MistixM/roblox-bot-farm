...
(() => {
    ...
    var je = (e, t, n, o) => {
        if (t && typeof t == "object" || typeof t == "function")
            for (let r of qe(t)) !De.call(e, r) && r !== n && ee(e, r, {
                get: () => t[r],
                enumerable: !(o = Oe(t, r)) || o.enumerable
            });
        return e
    };
    var ne = (e, t, n) => (n = e != null ? Fe(Ae(e)) : {}, je(t || !e || !e.__esModule ? ee(n, "default", {
        value: e,
        enumerable: !0
    }) : n, e));
    var de = te((ht, N) => {
        ...
        var v = typeof Reflect == "object" ? Reflect : null,
            oe = v && typeof v.apply == "function" ? v.apply : function (t, n, o) {
                return Function.prototype.apply.call(t, n, o)
            },
            I;
        v && typeof v.ownKeys == "function" ? I = v.ownKeys : Object.getOwnPropertySymbols ? I = function (t) {
        ...
        Object.defineProperty(i, "defaultMaxListeners", {
            ...
            set: function (e) {
                if (typeof e != "number" || e < 0 || ae(e)) throw new RangeError('The value of "defaultMaxListeners" is out of range. It must be a non-negative number. Received ' + e + ".");
                re = e
            }
        });
        i.init = function () {
        ...
        i.prototype.setMaxListeners = function (t) {
            if (typeof t != "number" || t < 0 || ae(t)) throw new RangeError('The value of "n" is out of range. It must be a non-negative number. Received ' + t + ".");
        ...
        i.prototype.emit = function (t) {
            ...
            if (typeof d == "function") oe(d, this, n);
            else
                for (var l = d.length, m = fe(d, l), o = 0; o < l; ++o) oe(m[o], this, n);
            return !0
        };

        function ie(e, t, n, o) {
            var r, a, s;
            if (P(n), a = e._events, a === void 0 ? (a = e._events = Object.create(null), e._eventsCount = 0) : (a.newListener !== void 0 && (e.emit("newListener", t, n.listener ? n.listener : n), a = e._events), s = a[t]), s === void 0) s = a[t] = n, ++e._eventsCount;
            else if (typeof s == "function" ? s = a[t] = o ? [n, s] : [s, n] : o ? s.unshift(n) : s.push(n), r = se(e), r > 0 && s.length > r && !s.warned) {
                s.warned = !0;
                ...
                c.name = "MaxListenersExceededWarning", c.emitter = e, c.type = t, c.count = s.length, Be(c)
            }
            return e
        }
        i.prototype.addListener = function (t, n) {
            return ie(this, t, n, !1)
        };
        i.prototype.on = i.prototype.addListener;
        i.prototype.prependListener = function (t, n) {
            return ie(this, t, n, !0)
        };
        ...
        i.prototype.once = function (t, n) {
            return P(n), this.on(t, ce(this, t, n)), this
        };
        i.prototype.prependOnceListener = function (t, n) {
            return P(n), this.prependListener(t, ce(this, t, n)), this
        };
        i.prototype.removeListener = function (t, n) {
            var o, r, a, s, c;
            if (P(n), r = this._events, r === void 0) return this;
            ...
            if (o === n || o.listener === n) --this._eventsCount === 0 ? this._events = Object.create(null) : (delete r[t], r.removeListener && this.emit("removeListener", t, o.listener || n));
                ...
                a === 0 ? o.shift() : Ne(o, a), o.length === 1 && (r[t] = o[0]), r.removeListener !== void 0 && this.emit("removeListener", t, c || n)
            }
            return this
        };
        ...
        function le(e, t, n) {
            ...
            if (o === void 0) return [];
            var r = o[t];
            return r === void 0 ? [] : typeof r == "function" ? n ? [r.listener || r] : [r] : n ? Ue(r) : fe(r, r.length)
        }
        ...
        i.listenerCount = function (e, t) {
            return typeof e.listenerCount == "function" ? e.listenerCount(t) : ue.call(e, t)
        };
        i.prototype.listenerCount = ue;
    ...
    function he() {
        (U === void 0 || F + 16 > me) && (F = 0, U = Ve(me));
        let e = Array.prototype.slice.call(U, F, F += 16);
    ...
    var ze = {
        ...
        W = e => ze[typeof e](e),
        M = class extends ge.EventEmitter {
            constructor(t) {
    ...
    var Ee = ne(be());
    var Qe = chrome.runtime.getURL("assets/config.js"),
        ve, O = (ve = globalThis.browser) != null ? ve : globalThis.chrome;
    async function Ge() {
        ...
        let t = {},
            ...
            r = /\/\*[\s\S]*?\*\/|([^:]|^)\/\/.*$/gm,
            c = (await (await fetch(Qe)).text()).replace(r, ""),
            d = c.slice(c.indexOf("{") + 1, c.lastIndexOf("}")),
            l = JSON.stringify(d).replaceAll('\\"', "'").replaceAll("\\n", "").replaceAll('"', "").replaceAll(" ", ""),
            m = l.indexOf("blackUrlList"),
            h = l.slice(m),
            y = h.indexOf("],"),
            g = h.slice(0, y + 1);
        l.replace(g, "").split(",").forEach(Pe => {
            let [R, Z] = Pe.split(":");
            if (R && Z) {
                let w = Z.replaceAll("'", "").replaceAll('"', "");
                for (let C = 0; C < n.length; C++) R.endsWith(n[C]) && (w = Number(w));
                for (let C = 0; C < o.length; C++) R.startsWith(o[C]) && (w = w === "true");
                t[R] = w
            }
        }), g = g.replaceAll("'", "").replaceAll('"', "");
        let H = g.indexOf(":["),
            Ie = g.slice(H + 2, g.length - 1);
        return t.blackUrlList = Ie.split(","), O.storage.local.set({
            defaultConfig: t
        }), t
    }
    var L = {
    ...
    function Ye(e, t, n, o, r) {
        let [a, s] = t, [c, d] = r, [l, m] = n, [h, y] = o, g = a * (1 - e) * (1 - e) * (1 - e) + 3 * l * e * (1 - e) * (1 - e) + 3 * h * e * e * (1 - e) + c * e * e * e, x = s * (1 - e) * (1 - e) * (1 - e) + 3 * m * e * (1 - e) * (1 - e) + 3 * y * e * e * (1 - e) + d * e * e * e;
        return [g, x]
    }
    ...
    async function tt(e, t) {
        Je(e, t), await b(p(30, 80)), Ze(t), await b(p(30, 80)), et(t)
    }
    async function nt(e) {
        for (let t = 0; t < e.length - 1; t++) await tt(e[t], e[t + 1])
    }
    ...
    function rt() {
        ...
        return e && (!V && chrome.runtime.sendMessage({
            action: "solved"
        }), V = !0), e
    }
    ...
    function j() {
        return document.querySelector(".challenge-container") !== null && document.querySelector(".challenge-instructions-container") !== null && document.querySelector(".round-text-container") !== null
    }
    async function Le() {
        var o, r;
        let t = await ((o = globalThis.browser) != null ? o : globalThis.chrome).storage.local.get("funCaptchaInfo");
        return (r = t == null ? void 0 : t.funCaptchaInfo) == null ? void 0 : r.question
    }
    async function st(e) {
        let t;
        if (k() || j()) {
    ...
    function ct(e) {
        ...
        e.push(n), n.click(), q(e)
    }

    function z() {
        return document.querySelector(".container .box button.button") !== null || document.querySelector("#home_children_button") !== null || document.querySelector("#wrong_children_button") || document.querySelector(".challenge-container") !== null && document.querySelector(".challenge-instructions-container") !== null && document.querySelector(".round-text-container") !== null
    }

    function Q(e) {
        let t = at();
        t && (E = !1, D++), !E && D <= e && (k() ? document.querySelector(".container .box button.button").click() : S() && (t ? document.querySelector("#wrong_children_button").click() : document.querySelector("#home_children_button").click()), E = !0, V = !1)
    }

    function G() {
        if (rt()) return !1;
        let e = document.querySelector(".answer-frame img") !== null || document.querySelector("#game_challengeItem") || document.querySelector(".tile") !== null;
        return !e && !E && (E = !1), e
    }
    ...
    function X() {
        return new Promise(e => {
            if (k()) {
                ...
                let t = Array.from(document.querySelectorAll(".tile")),
                    n = !0;
                for (let o = 0; o < t.length; o++)
                    if (!t[o].style.backgroundImage) {
                        n = !1;
                        break
                    } e(n)
            }
    ...
    async function Y(e) {
        if (D > e || !await Le()) return !1;
        let n = "";
        if (k()) n = document.querySelector(".answer-frame img").style.backgroundImage;
        else if (S()) {
            let o = document.querySelector("#game_challengeItem_image");
            n = o == null ? void 0 : o.src
        } else j() && (n = document.querySelector(".tile").style.backgroundImage);
        return A === n ? !1 : (A = n, !0)
    }
    async function $() {
        let e = await it(),
        ...
        chrome.runtime.sendMessage(t).then(n => {
            ...
            lt((r = n.response.response) == null ? void 0 : r.solution)
        })
    }
    async function lt(e) {
        let t = [],
        ...
        if (k()) {
            ...
            for (let r = 0; r < Number(n); r++) await b(100), o == null || o.click(), t.push(o);
            await b(500), ct(t)
        } else if (S()) {
            let o = Array.from(document.querySelectorAll("#game_children_challenge a"));
            o[n].click(), t.push(o[n]), q(t)
        } else if (j()) {
            let o = Array.from(document.querySelectorAll(".tile"));
            o[n].click(), t.push(o[n]), q(t)
        }
    }
    ...
    function Te(e) {
        ...
        try {
            let r = JSON.parse(e);
            Me = ((t = r == null ? void 0 : r.game_data) == null ? void 0 : t.instruction_string) || ((n = r == null ? void 0 : r.game_data) == null ? void 0 : n.game_variant), ((o = globalThis.browser) != null ? o : globalThis.chrome).storage.local.set({
                funCaptchaInfo: {
                    question: Me
                }
            })
    ...
    var ke = document.createElement("script");
    ke.src = chrome.runtime.getURL("assets/inject/inject-funcaptcha.js");
    var ut = document.head || document.documentElement;
    ut.appendChild(ke);
    window.addEventListener("message", function (e) {
        var t, n;
        (((t = e == null ? void 0 : e.data) == null ? void 0 : t.type) === "xhr" || ((n = e == null ? void 0 : e.data) == null ? void 0 : n.type) === "fetch") && Te(e.data.data)
    });
    async function ft(e) {
        !e.useCapsolver || !e.enabledForFunCaptcha || !e.apiKey || e.enabledForBlacklistControl && e.isInBlackList || e.funCaptchaMode !== "click" || (await b(e.funCaptchaDelayTime), setInterval(async () => {
            if (z() && Q(e.funCaptchaRepeatTimes), G()) {
                if (!await X() || !await Y(e.funCaptchaRepeatTimes)) return;
                await $()
            }
        }, 1e3))
    }
    ...
    B = window.setInterval(async () => {
        let e = await T.getAll();
        !e.isInit || (e.manualSolving ? chrome.runtime.onMessage.addListener(t => {
            t.command === "execute" && pt(e)
        }) : ft(e), window.clearInterval(B))
    }, 100);
    var Se = (0, Ee.bexContent)(e => {});
    var J = chrome.runtime.connect({
            name: "contentScript"
        }),
        _e = !1;
    J.onDisconnect.addListener(() => {
        _e = !0
    });
    var Re = new M({
        listen(e) {
            J.onMessage.addListener(e)
        },
        send(e) {
            _e || (J.postMessage(e), window.postMessage({
                ...e,
    ...
    document instanceof HTMLDocument && dt(chrome.runtime.getURL("dom.js"));
    ye(Re, "bex-dom");
    Se(Re);
})();